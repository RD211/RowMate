...
public class NotificationsServiceImpl implements NotificationsService {
    ...
    private HashMap<EventType, MailTemplate> messageTemplates;
     ...
     * regarding the sending of the notification
     */
    public void sendNotification(NotificationDTO notificationDTO) throws MailNotSentException {
        ...
        else sendNotificationActivityRelated(notificationDTO, message);
    }
